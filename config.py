...
## train set location
config.TRAIN.hr_img_path = 'DIV2_train_LR_wild'
config.TRAIN.lr_img_path = 'DIV2/DIV2K_train_LR_wild/'

config.VALID = edict()
## test set location
config.VALID.hr_img_path = 'DIV2/DIV2K_valid_HR/'
config.VALID.lr_img_path = 'DIV2/DIV2K_valid_LR_difficult/'
